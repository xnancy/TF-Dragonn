...
def interval_queue(intervals, labels, dequeue_size=128, name='interval-queue'):
    ...
    Returns:
        a dictionary of tensors with keys [chrom, start, stop, labels], where each
    ...
    with tf.variable_scope(name):
        ...
        stop_queue = tf.train.input_producer(
            k['stop'], shuffle=False, capacity=_DEFAULT_BUFFER_CAPACITY, name='stop-buffer')
        ...
        outputs = {
            ...
            'stop': stop_queue.dequeue_many(dequeue_size),
